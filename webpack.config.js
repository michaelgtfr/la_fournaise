...
Encore
    ...
    .addEntry('listOfProduct', './assets/listOfProduct.js')
    ...
    .addEntry('applicationInformation', './assets/applicationInformation.js')
    .addEntry('updateClientProfile', './assets/updateClientProfile.js')
